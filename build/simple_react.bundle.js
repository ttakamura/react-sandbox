...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = function (_React$Component2) {
	    ...
	    function Todo(props) {
	        ...
	        _this2.checkEnter = function (e) {
	            if (e.key === 'Enter') {
	                _this2.props.onEdit(_extends({}, _this2.props.task, { title: e.target.value }));
	                _this2.setState({ editing: false });
	            }
	        };

	        _this2.beginEdit = function () {
	            _this2.setState({ editing: true });
	        };

	        _this2.toggleTodo = function () {
	            _this2.props.toggleTodo(_this2.props.task);
	        };
	    ...
	    _createClass(Todo, [{
	        ...
	        value: function render() {
	            ...
	            var toggle = task.done ? _react2.default.createElement(
	                'span',
	                null,
	                '[x]'
	...
	var TodoList = function TodoList(props) {
	    return _react2.default.createElement(
	        ...
	        props.tasks.map(function (task) {
	            return _react2.default.createElement(Todo, { task: task, key: task.id, onEdit: props.onEdit, toggleTodo: props.toggleTodo });
	        })
	    );
	};
	...
	var App = function (_React$Component3) {
	    ...
	    function App(props) {
	        ...
	        _this3.addTask = function () {
	            _this3.setState({ tasks: [].concat(_toConsumableArray(_this3.state.tasks), [{
	                    id: nextId(),
	                    title: 'new',
	                    done: false
	                }]) });
	        ...
	        _this3.toggleTodo = function (newTask) {
	            _this3.state.tasks.forEach(function (task) {
	                if (task.id == newTask.id) {
	                    task.done = !task.done;
	                }
	            });
	            _this3.setState({ tasks: _this3.state.tasks });
	        };

	        _this3.onEdit = function (newTask) {
	            _this3.setState({ tasks: _this3.state.tasks.map(function (task) {
	                    if (task.id == newTask.id) {
	                        return newTask;
	                    } else {
	                        return task;
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement('input', { type: 'button', onClick: this.addTask, value: 'Add Task' }),
	                _react2.default.createElement(TodoList, { tasks: this.state.tasks, onEdit: this.onEdit, toggleTodo: this.toggleTodo })
	            );
	        }
	    }]);
	...
	window.setupSimpleReactApp = function () {
